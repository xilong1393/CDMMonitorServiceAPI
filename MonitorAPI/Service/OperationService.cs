...
namespace MonitorAPI.Service
{
    public class OperationService : BaseService
    {
        ...
        public CommandParameter UpdateIPCConfig(int classroomID, string sessionID = "")
        {
            UpdateEngineConfigurationParameter engineConfig = new UpdateEngineConfigurationParameter();
            UpdateAgentConfigurationParamerer agentConfig = new UpdateAgentConfigurationParamerer();
            CommandParameter parameter = new CommandParameter();
        ...
        private List<ClassRecordingWithSchedule> GetClassRecordingbyClassroomIDAndDate(int nClassroomID, DateTime dateTime)
        {
            using (PersistenceContext pc = new PersistenceContext())
            {
                OperationDao operationDao = new OperationDao(pc);
                List<ClassRecordingWithSchedule> list = operationDao.GetClassRecordingbyClassroomIDAndDate(nClassroomID, dateTime);
                return list;
            }
        }
        ...
        public DataTable GetClassRecordingTablebyClassroomIDAndDate(int classroomID, DateTime dateTime)
        {
            List<ClassRecordingWithSchedule> list = GetClassRecordingbyClassroomIDAndDate(classroomID, dateTime);
            return CreateDataTable(list);
        }
